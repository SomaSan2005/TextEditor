...
# root.iconbitmap('c:/gui/images.ico')
...
def copy_text(e):
    ...
    # chek to see if we used keyboard shortcuts
...
def night_on():
    ...
    context_menu.config(bg=main_color, fg=text_color)
...
# menu context
context_menu = tk.Menu(my_text, tearoff=0)
...
my_text.bind("<Button-3>", show_context_menu)
...
font_size = 12
text.config(font=("TkDefaultFont", font_size))
